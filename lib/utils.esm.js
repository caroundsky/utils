...
(function updateModules() {
  ...
  requireModule.keys().forEach(function (fileName) {
    var moduleDefinition = requireModule(fileName); // 拆分文件路径，并以驼峰格式存储各路径层次名至数组

    var modulePath = fileName.replace(/^\.\//, "").replace(/\.\w+$/, "").split(/\//);
...
export { registerUtils as default };
