...
function downLoadFile(options) {
    var _this = this;
    var _a = setDefalut(options, DEFAULT_VALUE), config = _a.config, fileName = _a.fileName, suffix = _a.suffix, errReg = _a.errReg;
    return new Promise(function (resolve, reject) {
        axios(__assign({ method: 'post', responseType: 'blob', withCredentials: true }, config))
            .then(function (res) { return __awaiter(_this, void 0, void 0, function () {
            var headers, data, status, _fileName, disposition, filenameRegex, matches, type, blob, content, e_1, URL, downloadUrl, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        headers = res.headers, data = res.data, status = res.status;
                        if (status !== 200)
                            return [2 /*return*/, reject(res)];
                        _fileName = '';
                        if (fileName) {
                        ...
                        blob = new Blob([data], { type: type }) || new File([data], _fileName, { type: type });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
