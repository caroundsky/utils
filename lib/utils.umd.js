(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function downLoadFile(options) {
        ...
        var config = options.config, fileName = options.fileName, suffix = options.suffix, errReg = options.errReg;
        return new Promise(function (resolve, reject) {
            axios(__assign({ method: 'post', responseType: 'blob', withCredentials: true }, config))
                .then(function (res) { return __awaiter(_this, void 0, void 0, function () {
                var headers, data, status, _fileName, disposition, filenameRegex, matches, type, blob, content, URL, downloadUrl, a;
